          ...
          <div className="login-main">
            <Form className="theme-form login-form">
              ...
              <FormGroup style={{ position: "relative" }}>
                <Label className="col-form-label m-0 pt-0">Mobile No.</Label>
                ...
                <Input style={{marginTop:"10px"}} type="text" placeholder="enter otp"/>
              </FormGroup>
              ...
              <FormGroup>
                <select style={{width:"370px",border:"1px solid #DEE2E6",borderRadius:"5px",background:"#F3F3FF"}}>
                  <option >Staff</option>
