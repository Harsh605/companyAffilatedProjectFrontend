export const MENUITEMS = [
...

  {
    ...
    Items: [
      ...
      { path: `${process.env.PUBLIC_URL}/app/bookmark`, icon: "bookmark", type: "link", title: "Withdraw" },
      // {
      //   title: "Contact",
      //   icon: "contact",
      //   type: "link",
      ...
      // },
      { path: `${process.env.PUBLIC_URL}/app/task`, icon: "task", type: "link", title: "Training Modules" },
      { path: `${process.env.PUBLIC_URL}/app/calendar/draggable-calendar`, icon: "calendar", type: "link", title: "Help/ Support" },
